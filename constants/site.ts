export const SITE = {
  name: "David Barbillo",
  role: "Software Engineer — Frontend & Full Stack Java",
  shortRole: "Frontend / Full Stack Developer",
  tagline:
    "Construyo interfaces rápidas y mantenibles, y las respaldo con una comprensión real de la infraestructura que las sostiene.",
  description:
  ...
  quickFacts: [
    ...
    { label: "Foco actual", value: "React / TypeScript" },
    { label: "En expansión", value: "Java & Spring Boot" },
    { label: "Diferencial", value: "Infraestructura & Sistemas" },
  ],
} as const;
